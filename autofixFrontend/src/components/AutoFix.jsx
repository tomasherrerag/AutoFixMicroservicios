...
const StyledButton = styled(Button)(({ theme }) => ({
  ...
  padding: theme.spacing(2), // Aumenta el tamaño del botón
...
const AutoFix = () => {
  return (
    <StyledContainer>
      ...
      <ButtonContainer>
        <StyledButton variant="contained">Menú Citas</StyledButton>
        <StyledButton variant="contained">Menú Vehículos</StyledButton>
        <StyledButton variant="contained">Menú Marcas</StyledButton>
        <StyledButton variant="contained">Menú Reparaciones</StyledButton>
      </ButtonContainer>
    </StyledContainer>
  );
};
